...
def build_viewer(export_dir, output_dir, preserve_viewer_data=True, asset_archive_dir=ASSET_ARCHIVE_DIR):
    ...
    ensure_viewer_assets(output_dir, asset_archive_dir=asset_archive_dir)
...
def ensure_viewer_assets(output_dir, asset_archive_dir=ASSET_ARCHIVE_DIR):
    asset_dir = output_dir / "viewer_assets"
    print(f"Copying offline renderer assets from {asset_archive_dir}...")
    copy_archive_to(asset_dir, archive_dir=asset_archive_dir)
    print(f"  copied local asset archive to {asset_dir}")
...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            "Path to canonical offline renderer assets archive (must contain manifest.json). "
    ...
    build_viewer(
        export_dir,
        output_dir,
        preserve_viewer_data=args.preserve_viewer_data,
